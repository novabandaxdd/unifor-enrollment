...
<head>
    ...
    <meta name="description" content="Unifor — Sistema de Matrícula 2025.1">

    <title>${msg("loginTotpTitle")!""} — Unifor Enrollment</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Wrapper de senha com botão de visibilidade */
        .password-wrap {
            position: relative;
        }
